...
;;;;
;;;; 库内用法:
;;;;   (clh-test:run-all)    → 运行全部离线套件,返回失败计数
;;;;   (clh-test:run-all t)  → 附加真机联调套件(需 CLH_LIVE=1 与 API Key)
;;;;
